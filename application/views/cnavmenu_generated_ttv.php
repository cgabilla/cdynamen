...
<head>
    ...
    <link rel="stylesheet"
          href="<?php echo $ttcConfig->AssetsUrl(); ?>assets/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.css">
...
<div class="page-wrapper">
    <aside class="sidebar sidebar-default">
        <nav>
            <h5 class="sidebar-header">A Navigator Menu</h5>
            <ul class="nav nav-pills nav-stacked">
                <li class="nav-dropdown">
                    <a href="#" title="Menu Levels">
                        <i class="fa fa-fw fa-folder-open"> </i>Menu Levels</a>
                    <ul class="nav-sub">
                        <li>
                            <a href="javascript:;" title="Level 2.1">
                                <i class="fa fa-fw fa-file"> </i>Level 2.1</a>
                        </li>
                        <li>
                            <a href="javascript:;" title="Level 2.2">
                                <i class="fa fa-fw fa-file"> </i>Level 2.2</a>
                        </li>
                        <li class="nav-dropdown">
                            <a href="#" title="Level 2.2">
                                <i class="fa fa-fw fa-folder-open"> </i>Level 2.2</a>
                            <ul class="nav-sub">
                                <li>
                                    <a href="javascript:;" title="Level 3.1">
                                        <i class="fa fa-fw fa-file"> </i>Level 3.1</a>
                                </li>
                                <li>
                                    <a href="javascript:;" title="Level 3.2">
                                        <i class="fa fa-fw fa-file"> </i>Level 3.2</a>
                                </li>
                                <li>
                                    <a href="javascript:;" title="Level 3.2">
                                        <i class="fa fa-fw fa-file"> </i>Level 3.2</a>
...
<script
    src="<?php echo $ttcConfig->AssetsUrl(); ?>assets/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
